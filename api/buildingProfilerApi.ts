...
import { AddressComponentRequest } from "../model/addressComponentRequest";
...
export class BuildingProfilerApi {
   ...
   * @summary Get home profile by address
   */
  public async getHomeProfileByAddress(
    address: string,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{ response: http.IncomingMessage; body: BuildingProfile }> {
    const localVarPath = this.basePath + "/api/v1/building-profile/address";
    ...
    if (address === null || address === undefined) {
      throw new Error(
        "Required parameter address was null or undefined when calling getHomeProfileByAddress.",
      );
    }
   ...
   * for a given residence.
   *
   * @param addressComponentRequest
   * @summary Get home profile by address components
   */
  public async getHomeProfileByAddressComponents(
    addressComponentRequest: AddressComponentRequest,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{ response: http.IncomingMessage; body: BuildingProfile }> {
    const localVarPath =
      this.basePath + "/api/v1/building-profile/address-components";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
    ...
    // verify required parameter 'addressComponentRequest' is not null or undefined
    if (
      addressComponentRequest === null ||
      addressComponentRequest === undefined
    ) {
      throw new Error(
        "Required parameter addressComponentRequest was null or undefined when calling getHomeProfileByAddressComponents.",
      );
    }
