...
/**
 * A class representing the set of possible building characteristics. All values
 * default to None, indicating that the given characteristic is unknown for the
 * represented residence. If a characteristic has the string value of "None" it
 * indicates that the characteristic, like Air Conditioning or a Pool, is not
 * present at the represented residence.
 */
export class BuildingFeatures {
  ...
  /**
   * The size of the garage as measured in the number of cars that can be
   * placed within the garage.
   */
  ...
  /** The fuel used by the water heater in the residence. */
  "waterHeaterFuel"?: Array<string>;
