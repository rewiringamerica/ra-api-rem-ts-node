...
/**
 * Represents the impacts of an upgrade and the rates and emissions factors used
 * to compute these impacts.
 */
export class Savings {
  ...
  /**
   * A list of conversion factors used to compute the emissions from each
   * fuel.
   */
